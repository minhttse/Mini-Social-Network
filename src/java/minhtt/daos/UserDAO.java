...
public class UserDAO {
    public UserDTO checkLogin(String email, String password) throws SQLException {
        ...
        try {
            ...
            if (conn != null) {
                String sql = "Select email,fullName,password,registerdate,roleID,status\n" +
                            "FROM tblUsers\n" +
                ...
                if (rs.next()) {
                    ...
                    result = new UserDTO(email, fullName, "*****", registerdate, roleID, status);                    
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void create(UserDTO user) throws SQLException{
        ...
        try {
            ...
            if(conn!=null){
                ...
                stm.setString(4,user.getRegisterdate());
                stm.executeUpdate();          
            }
        } catch (Exception e) {
            e.printStackTrace();
