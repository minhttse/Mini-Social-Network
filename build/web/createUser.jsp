    ...
    <body>
        ...
        <div>
            ...
            <form action="MainController" method="POST" class="main-layout">
                Email<input type="email" name="txtEmail" class="ID" value="${param.txtEmail==null ?"":param.txtEmail}">
                ${requestScope.USER_ERROR.emailError}</br>

                Full Name<input type="text" name="txtFullName" class="name" value="${param.txtFullName==null ?"":param.txtFullName}">
                ...
                <c:if test="${sessionScope.VERIFY_NUMBER !=null}">
                    <h4>We sent verify code to your email, please check and input code for register</h4>
